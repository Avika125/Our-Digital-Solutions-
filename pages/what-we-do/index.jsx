      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center text-center mb-20 max-w-[800px] mx-auto">
          <motion.h2
            ...
            animate="show"
            exit="hidden"
            className="h2 font-playfair mb-6"
          >
        ...
        <div className="flex flex-col gap-y-24 max-w-5xl mx-auto mb-32">
          ...
          >
            <div className="lg:w-1/3">
              <h3 className="text-4xl font-playfair mb-4 text-accent">Above the screen</h3>
              <p className="text-2xl font-playfair italic">Strategy</p>
            </div>
          ...
          >
            <div className="lg:w-1/3">
              <h3 className="text-4xl font-playfair mb-4 text-accent">On the screen</h3>
              <p className="text-2xl font-playfair italic">Design + UX</p>
            </div>
            <div className="lg:w-2/3">
              <p className="text-white/60 mb-6 uppercase tracking-widest text-xs">
          ...
          >
            <div className="lg:w-1/3">
              <h3 className="text-4xl font-playfair mb-4 text-accent">Below the screen</h3>
              <p className="text-2xl font-playfair italic">Tech + Dev</p>
            </div>
            <div className="lg:w-2/3">
              <p className="text-white/60 mb-6 uppercase tracking-widest text-xs">
          ...
          >
            <div className="lg:w-1/3">
              <h3 className="text-4xl font-playfair mb-4 text-accent">In the brain</h3>
              <p className="text-2xl font-playfair italic">AI + Automation</p>
            </div>
            <div className="lg:w-2/3">
              <p className="text-white/60 mb-6 uppercase tracking-widest text-xs">
        ...
        >
          <h2 className="text-5xl font-playfair mb-8">Let’s make some magic.</h2>
          <button className="btn rounded-full border border-white/50 px-10 py-4 text-xl font-playfair hover:border-accent hover:text-accent transition-all duration-300">
            Get a quote
          </button>
        </motion.div>
      </div>
